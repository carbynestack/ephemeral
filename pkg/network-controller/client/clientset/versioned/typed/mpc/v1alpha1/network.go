...
import (
	...
	scheme "github.com/carbynestack/ephemeral/pkg/network-controller/client/clientset/versioned/scheme"
	"time"
...
func newNetworks(c *MpcV1alpha1Client, namespace string) *networks {
	return &networks{
		client: c.RESTClient(),
		ns:     namespace,
	}
