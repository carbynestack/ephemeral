...
import (
	...
	versioned "github.com/carbynestack/ephemeral/pkg/network-controller/client/clientset/versioned"
	internalinterfaces "github.com/carbynestack/ephemeral/pkg/network-controller/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/carbynestack/ephemeral/pkg/network-controller/client/listers/mpc/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MpcV1alpha1().Networks(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MpcV1alpha1().Networks(namespace).Watch(options)
			},
		},
		&mpcv1alpha1.Network{},
		resyncPeriod,
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mpcv1alpha1.Network{}, f.defaultInformer)
}
